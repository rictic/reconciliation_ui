 ...
 */
jQueryObject.prototype.bind = function(event_kind, something, handler) {};

/**
 * @param {string} event_kind
 * @param {function()=} handler 
 */
jQueryObject.prototype.unbind = function(event_kind, handler) {};
...
/** @param {*} val
  * @return {!boolean}
  */
jQuery.isArray = function(val) {}

/** @param {*} array
  * @param {!function(number,*)} f
  */
jQuery.each = function(array, f) {}

/** @param {*} array
  * @param {!function(*)} f
  */
jQuery.map = function(array, f) {}
...
/** @param {!string} url
  ...
  * @param {function(*)} handler
  */
jQuery.getJSON = function(url, params, handler) {}
...
/** @param {!string} url
  ...
  */
jQuery.post = function(url, params, handler, expectedKind) {}

/** @type {function(...)} */
jQuery.ajax = function(url, params, handler, expectedKind) {}


/** @param {*} v
  * @return {Array}
  */
jQuery.makeArray = function(v) {}

/** @param {Array} a
  * @param {*} v 
  * @return {!boolean}
  */
jQuery.inArray = function(a,v) {}

/** @param {Array} a
  * @param {function()} f
  * @return {Array}
  */
jQuery.grep = function(a, f) {}
